...
public class Pubgmc {
    ...
    public static final String VERSION = "1.10.8-alpha.last";
    ...
    public static final String DEPENDENCIES = "required-after:configuration@[1.0.3.1,);required:mixinbooter@[9.0,)";
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        LoadoutManager.registerLoadoutDirectory("tournament");
